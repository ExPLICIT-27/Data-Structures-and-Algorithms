...
#include <algorithm>
using namespace std;
vector <int> MinRobotCollisions(vector <int> positions, vector <int> healths, string directions){
    vector <int> indices;
...
int main(){
    vector <int> a = {3,5,2,6};
    vector <int> b = {10,10,15,12};
    string c = "RLRL";
    vector <int> d = MinRobotCollisions(a, b, c);
